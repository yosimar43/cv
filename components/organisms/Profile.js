  ...
  <Container>
   <div className="profile">
    ...
    <div className="languages">
     ...
     <IconObject flag="🇬🇧" title="English" type="secondary" text="B1 level" />
    </div>

    <Paragraph>
     Michael sinisterra is a front-end developer with a passion for creating
     experiences in the web.
    </Paragraph>
    <Paragraph>
     In general, in his career, he has seen how with JavaScript we can create
     things that the user loves to use. This is great because we can create
     tools and create experiences that the user can connect .
    </Paragraph>
    <Paragraph>
     I loves to interacting with the tech community and that`&apos;`s why i am
     always looking for new opportunities. Also i have a passion for learning
     new things and i am always looking ways to create new tech community .
    </Paragraph>
    <Paragraph>
     I also enjoys mentoring. I trying to help people to learn new things and
     share with others.
    </Paragraph>
    <Paragraph>
